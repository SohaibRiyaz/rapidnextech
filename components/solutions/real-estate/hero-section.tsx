    ...
    <section className="relative min-h-[calc(100dvh-4rem)] flex items-center justify-center overflow-hidden pt-16 md:pt-20 pb-8 md:pb-12 theme-transition">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-4 leading-relaxed">
          Respond instantly to WhatsApp and website inquiries, qualify buyers,
          and guide them to book property viewings without agents manually
          replying to every message.
        </p>

        <p className="text-sm text-muted-foreground mb-6">
          Works with your current calendar or a booking page we build on your
          website.
        </p>
        ...
        <p className="mt-4 text-xs text-muted-foreground max-w-lg mx-auto">
          See how it qualifies leads and schedules viewings in real time.
        </p>
        ...
        <div className="mt-10 md:mt-12 relative max-w-3xl mx-auto">
          <div className="grid grid-cols-3 gap-3 md:gap-4">
            ...
            <div className="rounded-xl border border-border bg-card/50 backdrop-blur-sm p-4 md:p-6 text-left">
              ...
              <div className="text-2xl md:text-3xl font-bold text-foreground">2-3x</div>
              <div className="text-xs text-muted-foreground mt-1">Qualified inquiries</div>
            </div>
            <div className="rounded-xl border border-border bg-card/50 backdrop-blur-sm p-4 md:p-6 text-left">
              <div className="w-8 h-1.5 rounded-full bg-primary/50 mb-3" />
              <div className="w-full h-2 rounded bg-muted mb-2" />
              <div className="w-5/6 h-2 rounded bg-muted mb-4" />
              <div className="text-2xl md:text-3xl font-bold text-foreground">40% faster</div>
              <div className="text-xs text-muted-foreground mt-1">Viewing bookings</div>
            </div>
          </div>
        </div>
      </div>
