...
const offers = [
  {
    icon: Globe,
    title: "Booking or Plan Checkout Page",
    tag: "Optional Add-On",
    description:
      "No booking tool? We can build a lightweight booking or plan checkout page directly on your website. It plugs into the WhatsApp flow so clients can confirm and pay in minutes.",
    benefits: [
      "Hosted on your domain - you own it",
      "Mobile-first, fast-loading design",
      "Integrated with WhatsApp confirmation flow",
      "Supports Stripe or Shopify checkout",
    ],
  ...
  {
    icon: Phone,
    title: "AI Call Agent / Intake Assistant",
    tag: "Upsell",
    description:
      "Handle incoming phone calls with an AI agent that answers 24/7. Captures goals, shares availability, and sends a WhatsApp follow-up with a booking link automatically.",
    benefits: [
      "24/7 phone answering - no missed calls",
      "Natural-sounding AI voice agent",
      "Captures caller goals and contact details",
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            These are optional. The core system works perfectly on its own.
            But if you want a booking or checkout page or never miss a phone call,
            we can help.
          </p>
        </div>
